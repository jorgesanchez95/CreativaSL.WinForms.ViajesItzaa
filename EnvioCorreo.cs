...
namespace CreativaSL.WinForms.ViajesItzaa.Desktop.ClasesAux
{
    public class EnvioCorreo
    {
        ...
        public static string GenerarHtmlCancelacion(Solicitud Datos)
        {
            ...
            <h3 style=""text-align: center;color: #8CBE3F;font-size: 22px;margin: 5px 0 5px 0;font-weight: normal;font-family: Helvetica, Arial, sans-serif;line-height: 18px; font-style:italic;"">Registro Nacional de Turismo No. 04071010142</h3>
           ...
           <tr>
            ...
            <a href="""" style=""text-decoration:none;line-height:30px;color:#ffffff;"" target=""_blank""><span style=""text-decoration:none;color:#ffffff;"">Nos ponemos a sus órdenes en el momento que desee volver a contar con alguno de nuestros servicios. Recuerde visitar <a href=""" + dominio + @""" style=""text-decoration:none;line-height:30px;color:#ffffff;"" target=""_blank""><span style=""text-decoration:none;color:#ffffff;"">www.viajesitzaa.com<a> y encontrar novedades de viaje.</span></a></h3>
            </td>
            </tr>
            </tbody>
            </table>
            ...
            <tr>
            <td valign=""top"" class="""" bgcolor=""#3A5490"" style=""-webkit-text-size-adjust: none;"">
            <table class=""BoxWrap"" width=""600"" align=""center"" cellpadding=""0"" cellspacing=""0"">
            <tbody>
            <tr>
            <td style=""-webkit-text-size-adjust: none;"">
            ...
            <tr>
            <td style=""-webkit-text-size-adjust: none;"">
            <table class="""" bgcolor=""#3A5490"" width=""100%"" cellpadding=""14"" cellspacing=""0"">
            <tbody>
            <tr>
            <td style=""-webkit-text-size-adjust: none;"">
...
<tr>
            ...
            <tr>
            <td style=""-webkit-text-size-adjust: none;"">
            <h2 style=""text-align: center;margin: 20px 0 0 0;font-size: 16px;color: #000;font-weight: bold;line-height: 22px;text-decoration: none;text-transform: uppercase;font-family: Helvetica, Arial, sans-serif;"">La transportación que le brindamos es privada no se añade a ningún grupo y contamos con salidas diarias.</h2>
            <h2 style=""text-align: center;margin: 20px 0 0 0;font-size: 10px;color: #000;font-weight: bold;line-height: 18px;text-decoration: none;text-transform: uppercase;font-family: Helvetica, Arial, sans-serif;"">Para poder reservar con operadora turística itzaa, se realiza un depósito o transferencia bancaria del " + Anticipo + @"% del monto total del servicio y el otro " + AnticipoResto + @"% se liquida al llegar a Tuxtla Gutiérrez. </h2>
            <h2 style=""text-align: center;margin: 20px 0 0 0;font-size: 22px;color: #8CBE3F;font-weight: bold;line-height: 22px;text-decoration: none;text-transform: uppercase;font-family: Helvetica, Arial, sans-serif; font-style:italic;"">¡¡Esperamos contar con su preferencia!!</h2>
            </td>
            </tr>
            </tbody>
